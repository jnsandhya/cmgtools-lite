...
#ComponentCreator.useAAA = True  #Gives the place of samples to harvest
...
from CMGTools.cpTop.proto.samples.fall17.ttbar2017 import data_singletop
...
if (not data):
    ...
    selectedComponents = data_singletop
...
def select_electron_function(electron): #function use in the next Analyzer
    return electron.pt() > 35 and\
           ...
           electron.id_passes("cutBasedElectronID-Fall17-94X-V2","tight") and\
	   electron.iso_htt() < 0.0588
