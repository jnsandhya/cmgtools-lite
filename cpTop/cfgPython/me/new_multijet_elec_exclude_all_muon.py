...
from CMGTools.cpTop.proto.samples.fall17.ttbar2017 import reversed_electron
...
for sample in reversed_electron:
...
if (not data):
    ...
    selectedComponents = reversed_electron
...
def select_electron_function(electron): #function use in the next Analyzer
    return electron.pt() > 35 and\
	   ...
	   electron.id_passes("cutBasedElectronID-Fall17-94X-V2","veto")
