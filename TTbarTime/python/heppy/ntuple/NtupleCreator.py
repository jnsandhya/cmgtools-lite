...
weights = Block(
    ...
    weight_syst_id = v(lambda x : getattr(x, 'systIdWeight', 1.)),
    weight_syst_iso = v(lambda x : getattr(x, 'systIsoWeight', 1.)),
    weight_syst_trig_isomu27 = v(lambda x : getattr(x, 'systTrigIsoMu27Weight', 1.)),
    weight_syst_trig_mu50 = v(lambda x : getattr(x, 'systTrigMu50Weight', 1.)),
